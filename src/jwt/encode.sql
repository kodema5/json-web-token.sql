...
\if :test
    create or replace function tests.test_jwt_encode_w_token_from_jwt_io() returns setof text as $$
    declare
        -- a token from jwt-io
    ...
    create or replace function tests.test_jwt_encode_with_static_key() returns setof text as $$
    declare
    ...
    create or replace function tests.test_jwt_encode_invalid_token() returns setof text as $$
    begin
